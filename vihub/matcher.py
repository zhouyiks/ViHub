...
class NewInsHungarianMatcher(nn.Module):
    ...
    def memory_efficient_forward(self, outputs, targets, prev_frame_indices=None):
        ...
        for b in range(B):
            ...
            redirect_new_src_i = new_src_i - (Q - self.num_new_ins)
            new_ins_indices.append((redirect_new_src_i, new_tgt_i))
